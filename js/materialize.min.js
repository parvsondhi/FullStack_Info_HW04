...
$(document).ready( function () {
    $("#new-item").on('click', function() {
        ...
        callAPI(user_input);
        console.log("onclick: ",search[1].link);
  	});
});
console.log("after click: ",search.link);
...
function populatePage () {
	// populates the interface with appropriate divs
		...
		$('#search-row-'+i).prepend('<div class="col s2"><a id="play-track" class="waves-effect waves-light btn" onclick="play(this);">PLAY</a></div>');
		...
		console.log("inside callAPI function: ", search[i].link)
}

function play (element) {
	changeTrack(search.link);
}
