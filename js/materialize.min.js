	...
	$.get("https://api.soundcloud.com/tracks?client_id=b3179c0738764e846066975c2571aebb",
		...
		function(data) {
			...
			for (i=0; i < 20; i++) {
				...
				document.getElementById("play-track-"+i).onclick = function() {changeTrack(search.link)};
			}
		},'json'
	);
...
function populatePage (data) {
		...
		$('#search-row-'+i).prepend('<div class="col s2"><a id="add-to-playlist-track-'+i+'" class="waves-effect waves-light btn">'+'ADD TO PLAYLIST'+'</a></div>');
		$('#search-row-'+i).prepend('<div class="col s2"><a id="play-track-'+i+'" class="waves-effect waves-light btn">PLAY</a></div>');
		$('#search-row-'+i).prepend('<div class="col s2"><p>'+search[i].artist+'</p></div>');
		$('#search-row-'+i).prepend('<div class="col s2"><p>'+search[i].title+'</p></div>');
		$('#search-row-'+i).prepend('<div id="search-track-img" class="col s2"><img id="search-track-img" src="'+search[i].artwork+'"/></div>');
}
